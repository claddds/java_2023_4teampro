...
//	}
	...
	// mapper 로가서 prn_time sql문 실행하고 값을 가져오자.
		...
		/*public static List<TicketBox_VO> getMovieByName(String movieName){
		System.out.println("DAO와서 sql문 하고올게요44");
		List<TicketBox_VO> vo  = getSession().selectOne("getMovieByName", movieName);
		System.out.println("mapper다녀왔어요44" + vo);
		return vo;
	}*/
}
