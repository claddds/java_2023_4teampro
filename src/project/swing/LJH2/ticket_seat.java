...
public class ticket_seat extends JFrame {
	...
	public ticket_seat() {
		...
		pg1.add(j1);
		pg1.add(show_room); // DB와 연결하여 리스트에 뜬 영화 중에 선택한 영화 출력되게하기.
		...
		pg3.add(j3);
		pg3.add(show_peo); // 콤보박스에서 선택한 인원수가 뜨도록 출력되게하기
		...
		room.addActionListener(new ActionListener() {
		    ...
		    public void actionPerformed(ActionEvent e) {
		        ...
		        test.resetSeatSelection(); // seat_test 클래스에 resetSeatSelection() 메서드를 구현해야 합니다.
	...
	//room 변수의 콤보박스인 개나리, 빛나리, 미나리를 선택했을 경우 좌석도와 스크린위치가 변하게 하는
	//액션리스너 추가함. 
