	...
	public ticket_office_main() {
		...
		ticket_bt.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				posterIcon = (ImageIcon)show_poster.getIcon();
				
				ticket_seat con_seat = new ticket_seat(show_room.getText(), show_date.getText(),
				        show_time.getText(), show_peo1.getText(), show_peo2.getText(),
				        show_price3.getText(),posterIcon);
				setVisible(false);
