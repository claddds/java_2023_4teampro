...
public class ticket_seat extends JFrame {
	...
	public ticket_seat(String selectedRoom, String selectedDate, String selectedTime,
            String selectedAdult, String selectedChild, String totalPrice,ImageIcon moviePoster) {
		super("좌석선택창");
		...
		pg7.add(j6);
		pg7.add(show_theater); //미나라, 상영관 선택라벨
		...
		//매표소값을인자로 받은것을 추가
		show_room.setText(selectedRoom);
	    show_date.setText(selectedDate);
	    show_time.setText(selectedTime);
	    show_peo1.setText(selectedAdult);
	    show_peo2.setText(selectedChild);
	    show_price3.setText(totalPrice);
	    show_poster.setIcon(moviePoster);
		...
		pay_bt.addActionListener(new ActionListener() {
			...
			@Override
			 public void actionPerformed(ActionEvent e) {
		        poster1 = (ImageIcon) show_poster.getIcon();
		        ticket_before_pay paymentWindow = new ticket_before_pay(
		                ticket_seat.this,  // ticket_seat 클래스의 인스턴스를 참조하기 위해 ticket_seat.this 사용
		                poster1,
		                show_date.getText(),
		                show_time.getText(),
		                show_peo1.getText(),
		                show_peo2.getText(),
		                show_theater.getText(),
		                seatLabel.getText(),
		                show_price3.getText()
	...
	public void setSeatNumber(String seatNumber) {
	    seatLabel.setText("선택한 좌석: " + seatNumber);
	}
	private void updateSeatLabel() {
		...
		seatLabel.setText("선택한 좌석 : "+labelText);
	}
